...
categories: [digital map, Tribal areas, spectrum, AGOL, statistics]
image: "tpw.png"
---
...
The layers illustrating differences between the proposed and restrictive definitions of eligibility are based on the calculation of population within Tribal areas within a given Partial Economic Area (PEA; for each definition of Tribal eligibility). Shown in blue or yellow (dashed boundary lines) are the areas in which the percent of population within a Tribal area of that PEA differed by more than 5%.
...
The [Rural Tribal Window Applications (Pending and Accepted for Filing)](https://fcc.maps.arcgis.com/apps/webappviewer/index.html?id=b51c97987df5452da4a2b37ec6c28d09) map from the FCC was used to show the more restrictive definition of eligible Tribal lands. More specifically, the layer [Eligible Tribal Lands](https://services.arcgis.com/YnOQrIGdN9JGtBh4/ArcGIS/rest/services/eligible_tribal_lands/FeatureServer/0) was used.
